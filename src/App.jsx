      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">
            {lang === "en" ? "Bulk Market" : "Mercado al por Mayor"}
          </h1>
          <p className="mt-1 text-sm text-gray-600">
            {lang === "en"
              ? "Wholesale offers — catalog only. Request quotes for orders."
              : "Ofertas al por mayor — solo catálogo. Solicita presupuesto para pedidos."}
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden md:flex items-center gap-2 text-sm">
            ...
            <button
              onClick={() => setLang("es")}
              className={`px-3 py-1 rounded ${
                lang === "es" ? "bg-gray-900 text-white" : "bg-white border"
              }`}
            >
              ES
            </button>
          ...
          >
            {lang === "en" ? "Request Quote" : "Solicitar Presupuesto"}
          </button>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto mt-8">
            ...
            <input
              ...
              placeholder={
                lang === "en"
                  ...
                  : "Buscar productos, descripciones..."
              }
        ...
        <section className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((p) => (
            ...
            >
              <img
                src={p.image}
                alt={lang === "en" ? p.name_en : p.name_es}
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  {(lang === "en" ? p.desc_en : p.desc_es).slice(0, 120)}
                  {(lang === "en" ? p.desc_en : p.desc_es).length > 120
                    ? "..."
                    : ""}
                </p>
                  ...
                  <a
                    href={`mailto:${contactEmail}?subject=${encodeURIComponent(
                      ...
                      (lang === "en"
                        ...
                        : "Por favor envíe presupuesto para") +
                        " " +
                        (lang === "en" ? p.name_en : p.name_es) +
                        " - MOQ: " +
                        p.moq
          ...
          {filtered.length === 0 && (
            <div className="col-span-full bg-white rounded p-6 text-center text-gray-600">
              {lang === "en"
                ? "No products found."
        ...
        <footer className="mt-10 text-sm text-gray-600">
          <div className="flex flex-col md:flex-row md:justify-between gap-3 items-start md:items-center">
            <div>
              {lang === "en"
                ? "© 2025 Bulk Market — Catalog only. All prices indicative."
                : "© 2025 Mercado al por Mayor — Solo catálogo. Todos los precios indicativos."}
            </div>
            ...
            <div className="p-4 flex justify-between items-start">
              <div>
                <h2 className="text-xl font-semibold">
                  {lang === "en" ? selected.name_en : selected.name_es}
                </h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
              ...
              <div>
                <p className="text-sm text-gray-700">
                  {lang === "en" ? selected.desc_en : selected.desc_es}
                </p>
                <ul className="mt-4 space-y-2 text-sm text-gray-700">
                  <li>
                    <strong>{lang === "en" ? "MOQ:" : "MOQ:"}</strong>{" "}
                    {selected.moq}
                  </li>
                  <li>
                    <strong>
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  >
                    {lang === "en" ? "Email sales" : "Enviar email"}
                  </button>
                </div>
              </div>
            </div>
